...
void DiscoveryThread::Progress()
{
    emit SignalProgress(++current_progress);
}

void DiscoveryThread::Abort()
{
    snmp->aborting = true;
}
...
void Discovery::AddAgentToProfiles()
{
